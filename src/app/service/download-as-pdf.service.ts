    ...
    return new Promise((resolve) => {
      ...
      for (let key in this.academicCard) {
        ...
        let certificateDetails = [
          {
            text: `${this.academicCard[key][0][0]}`,
            style: 'tableHeader',
            colSpan: '2',
            alignment: 'center',
          },
          ...
          {
            text: `${this.academicCard[key][0][2]}`,
            style: 'tableHeader',
            alignment: 'center',
          },
        ];
    ...
    return new Promise(async (resolve) => {
      this.docDefinition = {
        content: [
          ...
          // This represents user's online profiles like : Gmail, LinkedIn, Github that can be take as in put using a form
          // {
...

          {
            table: {
              ...
              body: [
                ...
                [
                  { text: `Son/Wife/Daughter of ` },
                  { text: `${this.user.fatherName}` },
                  '',
                ],
