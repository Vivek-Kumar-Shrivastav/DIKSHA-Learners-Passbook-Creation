...
import { Subject, Certificate } from '../../HelperInterfaces/CertificateData';
...
export class CertificateDataService {
  ...
  getData(certificate: any) {
    // declare the type of certificate
    let newCertificates: Certificate = Object.assign({}, this.certificates);
    ...
    this.subjects = Array.from(
      certificate.xml?.getElementsByTagName('Subject')
    );
